...
*/
    ...
    virtual void drawncopo(plano T,int x,int y) = 0;
    virtual void drawnarbol(plano T, int x, int y, int n)=0;
};
 ...
 */
    void drawn(plano p, int x,int y);
    void drawncopo(plano p, int x,int y);
    void drawnarbol(plano p, int x, int y, int n);
};
